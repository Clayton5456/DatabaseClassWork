...
db.zips.find({$and:[{"pop":{$lt:2000}},{"state":"OH"}]},{"_id":1,"city":1,"pop":1,"state":1});
...
db.zips.find({$and:[{"city":"COLUMBIA"},{"state":"MO"}]},{"_id":1});
...
db.zips.find({"city":"SPRINGFIELD"},{"_id":0,"state":1});
...
db.stocks.find({$and:[{"Sector":"Real Estate"}, {"Price":{$lt:50}}]},{"_id":0, "Symbol":1, "Name":1, "Price":1});
